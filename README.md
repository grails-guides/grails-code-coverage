...
This repository contains the worked sample app for the [Grails Code Coverage](https://grails.apache.org/guides/grails-code-coverage/4/guide/index.html) guide on the Apache Grails site.
